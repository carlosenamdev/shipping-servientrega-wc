...
<table>
    <tr valign="top">
        ...
        <td scope="row" class="titledesc" style="display:block;margin-bottom:20px;margin-top:3px;padding-top:40px;">
            ...
            $htmlGeneral .= '<fieldset style="padding:3px;">
                <input class="input-text regular-input" required type="text" name="servientrega_billing_code" id="servientrega_billing_code "'; $disable =  ($validation === 'done') ? 'disabled="true "' : ' '; $htmlGeneral .= $disable;  $htmlGeneral .= 'value= "'; $value = (isset($general_settings['servientrega_billing_code'])) ? $general_settings['servientrega_billing_code'] : 'SER408'; $htmlGeneral .= "$value\">"; $htmlGeneral .= '<label for="servientrega_billing_code">' . __('Código de Facturación') . '</label> <span class="woocommerce-help-tip" data-tip="' . __('Código de Facturación lo encuentra dentro del panel de SISCLINET') . '"></span>
            </fieldset>';
            $htmlGeneral .= '<fieldset style="padding:3px;">
                <input class="input-text regular-input" required type="text" name="servientrega_billing_code_upon_delivery" id="servientrega_billing_code_upon_delivery "'; $disable =  ($validation === 'done') ? 'disabled="true "' : ' '; $htmlGeneral .= $disable;  $htmlGeneral .= 'value= "'; $value = (isset($general_settings['servientrega_billing_code_upon_delivery'])) ? $general_settings['servientrega_billing_code_upon_delivery'] : 'SER408'; $htmlGeneral .= "$value\">"; $htmlGeneral .= '<label for="servientrega_billing_code_upon_delivery">' . __('Código de Facturación (Contra Entrega)') . '</label> <span class="woocommerce-help-tip" data-tip="' . __('Código de Facturación lo encuentra dentro del panel de SISCLINET') . '"></span>
            </fieldset>';
            $htmlGeneral .= '<fieldset style="padding:3px;">
